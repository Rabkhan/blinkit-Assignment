/*
SELECT * FROM blinkit_city_map LIMIT 10; - To get the undestanding of data in the table
SELECT * FROM all_blinkit_category LIMIT 10; - To get the undestanding of data in the table
*/
